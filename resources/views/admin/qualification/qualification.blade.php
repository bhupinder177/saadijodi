    ...
    <div class="page-content">
      <section class="content-header">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-6">
              <form action="{{URL::to('/qualification')}}" method="get">
                <div class="row">
            <div class="col-md-7">
              <div class="form-group">
            <input class="form-control search" placeholder="Search" type="text">
            <input type="hidden" class="searchpagelink" value="{{URL::to($prefix.'/qualification')}}">
              </div>
            </div>
            ...
            <div class="col-3 col-md-2">
              <div class="form-group">
            <a class="btn btn-success getreset" value="Reset" data-href="{{ url($prefix.'/qualification') }}">Reset</a>
              </div>
            </div>
           </div>
          </form>
          ...
          <div class="col-md-6">
            <div class="refer-btn">
                <a class="btn btn-rounded"  href="{{ url($prefix.'/qualification-add')}}">Add Qualification</a>
            </div>
         </div>
       </div>
