    ...
    <ol class="breadcrumb">
      ...
      <div class="container-fluid">
          ...
          <div class="">
            ...
            <form action="{{ url($prefix.'/qualificationSave') }}" method="post" enctype="multipart/form-data" class="reset" id="addreligions">
      ...
      <input type="text" placeholder="Please enter qualification" class="form-control " name="name"   id="name">
                          </div>
                      </div>
