    ...
    <ol class="breadcrumb">
      ...
      <div class="container-fluid">
          ...
          <div class="">
            ...
            <form action="{{ url($prefix.'/qualification-update') }}" method="post" enctype="multipart/form-data" class="reset" id="addreligions">
      ...
      <input type="text" value="{{ $result->name }}" placeholder="Please enter qualification" class="form-control " name="name"   id="name">
                          </div>
