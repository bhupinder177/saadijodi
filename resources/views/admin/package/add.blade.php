    ...
    <ol class="breadcrumb">
      ...
      <div class="container-fluid">
          ...
          <div class="">
            ...
            <form action="{{ url($prefix.'/packagesSave') }}" method="post" enctype="multipart/form-data" class="reset" id="addpackage">
      ...
      <input type="text" placeholder="Please enter connects" class="form-control" name="connects"   id="connects">
                          </div>
                      </div>
                      <div class="col-sm-6">
                          <div class="form-group">
