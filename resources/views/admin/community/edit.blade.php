    ...
    <ol class="breadcrumb">
      ...
      <div class="container-fluid">
          ...
          <div class="">
            ...
            <form action="{{ url($prefix.'/community-update') }}" method="post" enctype="multipart/form-data" class="reset" id="addreligions">
      ...
      <input type="text" value="{{ $result->name }}" placeholder="Please enter community" class="form-control " name="name"   id="name">
                          </div>
