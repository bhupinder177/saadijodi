    ...
    <div class="page-content">
      <section class="content-header">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-6">
              <form action="{{URL::to('/mothertongue')}}" method="get">
                <div class="row">
            <div class="col-md-7">
              <div class="form-group">
            <input class="form-control search" placeholder="Search" type="text">
            <input type="hidden" class="searchpagelink" value="{{URL::to($prefix.'/mothertongue')}}">
              </div>
            </div>
            ...
            <div class="col-3 col-md-2">
              <div class="form-group">
            <a class="btn btn-success getreset" value="Reset" data-href="{{ url($prefix.'/mothertongue') }}">Reset</a>
              </div>
            </div>
           </div>
          </form>
          ...
          <div class="col-md-6">
            <div class="refer-btn">
                <a class="btn btn-rounded"  href="{{ url($prefix.'/mothertongue-add')}}">Add Mother Tongue</a>
            </div>
         </div>
       </div>
                      ...
                      <?php if(count($users) != 0){
                        ...
                        <tr class="data">
                            ...
                            <td >
                             ...
                             <a href="{{url($prefix.'/mothertongue-edit/'.Crypt::encrypt($u->id))}}"><i class="fa fa-edit"></i></a>
                             <a class="deleterecord" data-link="{{url($prefix.'/mothertongue-delete')}}" data-id="{{ $u->id }}"><i class="fa fa-trash deleterecord"  data-link="{{url($prefix.'/mothertongue-delete')}}"  data-id="{{ $u->id }}" aria-hidden="true"></i></a>
                             @endif
                             </td>
                        </tr>
                        @endforeach
