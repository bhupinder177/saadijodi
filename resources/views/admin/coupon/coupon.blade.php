      ...
      <section class="content-header">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <input type="hidden" class="searchpagelink" value="{{URL::to($prefix.'/coupon')}}">
              </div>
            </div>
            ...
            <div class="col-3 col-md-2">
              <div class="form-group">
            <a class="btn btn-success getreset" value="Reset" data-href="{{ url($prefix.'/coupon') }}">Reset</a>
              </div>
            </div>
           </div>
          </form>
          ...
          <div class="col-md-6">
            <div class="refer-btn">
                <a class="btn btn-rounded"  href="{{ url($prefix.'/coupon-add')}}">Add Coupon</a>
            </div>
         </div>
       </div>
                    ...
                    <tbody>
                      <?php if(count($users) != 0){
                        ...
                        <tr class="data">
                            ...
                            <td >
                             <a href="{{url($prefix.'/coupon-edit/'.Crypt::encrypt($u->id))}}"><i class="fa fa-edit"></i></a>
                             <a class="deleterecord" data-link="{{url($prefix.'/coupon-delete')}}" data-id="{{ $u->id }}"><i class="fa fa-trash deleterecord"  data-link="{{url($prefix.'/coupon-delete')}}"  data-id="{{ $u->id }}" aria-hidden="true"></i></a>
                             </td>
                        </tr>
                        @endforeach
                            <?php
