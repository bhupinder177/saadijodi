				...
				<div class="row">
					...
					<div class="col-md-3">
						...
						<div class="serach_filters">
		                  ...
		                  <div class="serach_filters_col">
		                  	<h6 class="text-uppercase mb-3 font-weight-bold">Active Members</h6>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="filter-size-1">
			                      <label class="custom-control-label" for="filter-size-1">All</label>
			                    </div>
			                  </div>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="filter-size-2">
			                      <label class="custom-control-label" for="filter-size-2">Within a day(14)</label>
			                    </div>
			                  </div>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="filter-size-3">
			                      <label class="custom-control-label" for="filter-size-3">Within a week(33)</label>
			                    </div>
			                  </div>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="filter-size-4">
			                      <label class="custom-control-label" for="filter-size-4">Within a month(67)</label>
			                    </div>
			                  </div>
		                  </div>

		                  <div class="serach_filters_col">
		                  	<h6 class="text-uppercase font-weight-bold mb-3">Recently Joined</h6>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="category-1">
			                      <label class="custom-control-label" for="category-1">All</label>
		                  ...
		                  <div class="serach_filters_col">
		                  	<h6 class="text-uppercase mb-3 font-weight-bold">Annual Incomes</h6>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="filter-size-1">
			                      <label class="custom-control-label" for="filter-size-1">All</label>
			                  ...
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="filter-size-2">
			                      <label class="custom-control-label" for="filter-size-2">Upto INR 1 Lak...(129)</label>
			                    </div>
			                  </div>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="filter-size-3">
			                      <label class="custom-control-label" for="filter-size-3">INR 1 Lakh to ...(41)</label>
			                    </div>
			                  </div>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="filter-size-4">
			                      <label class="custom-control-label" for="filter-size-4">INR 2 Lakh to ...(27)</label>
			                    </div>
			                  </div>
		                  </div>

		                  <div class="serach_filters_col">
		                  	<h6 class="text-uppercase font-weight-bold mb-3">Marital Status</h6>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="category-1">
			                      <label class="custom-control-label" for="category-1">All</label>
		                  ...
		                  <div class="serach_filters_col">
		                  	<h6 class="text-uppercase mb-3 font-weight-bold">Religion</h6>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="filter-size-1">
			                      <label class="custom-control-label" for="filter-size-1">All</label>
		                  ...
		                  <div class="serach_filters_col">
		                  	<h6 class="text-uppercase font-weight-bold mb-3">Community</h6>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="category-1">
			                      <label class="custom-control-label" for="category-1">All</label>
		                  ...
		                  <div class="serach_filters_col">
		                  	<h6 class="text-uppercase mb-3 font-weight-bold">Mother Tongue</h6>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="filter-size-1">
			                      <label class="custom-control-label" for="filter-size-1">All</label>
		                  ...
		                  <div class="serach_filters_col">
		                  	<h6 class="text-uppercase font-weight-bold mb-3">Country Grew up in</h6>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="category-1">
			                      <label class="custom-control-label" for="category-1">All</label>
		                  ...
		                  <div class="serach_filters_col">
		                  	<h6 class="text-uppercase mb-3 font-weight-bold">Working With</h6>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="filter-size-1">
			                      <label class="custom-control-label" for="filter-size-1">All</label>
		                  ...
		                  <div class="serach_filters_col">
		                  	<h6 class="text-uppercase font-weight-bold mb-3">Profession Area</h6>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="category-1">
			                      <label class="custom-control-label" for="category-1">All</label>
		                  ...
		                  <div class="serach_filters_col">
		                  	<h6 class="text-uppercase mb-3 font-weight-bold">Profile Created by</h6>
			                  <div class="mt-2 mb-2 pl-2">
			                    <div class="custom-control custom-checkbox">
			                      <input type="checkbox" class="custom-control-input" id="filter-size-1">
			                      <label class="custom-control-label" for="filter-size-1">All</label>
										...
										<div class="col-md-6">
											<div class="listing_details">
												...
												<div class="ListItemStyles__Bios">
													Hi, thank you for visiting my daughter's profile. She has completed her Bachelor's degree. She worke...
													<a class="ListItemStyles__ReadMoreLink" href="#">More</a>
												</div>
											</div>
										</div>
										<div class="col-md-3">
