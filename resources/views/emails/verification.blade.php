<table border="0" width="100%">
	<tbody>
							...
							<tbody>
								<tr>
                                    ...
                                    <td>
																			 Hi {{ $data['name'] }},
																			 <br/>
																			<p> Thanks for Signing up with Saddi Jodi</p>
        <p style="font-size: 14px;">We would like to update you that still your account is not activated. Please click below link to activate your account. </p>
				...
				<b><a style='display: block;width: 223px;height: 14px;background: #4E9CAF;padding: 10px;text-align: center;border-radius: 5px;color: white;font-weight: bold;text-decoration:none;' class='click' href="{{ $data['link'] }}">
